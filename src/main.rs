...
fn expensive_sum(v: Vec<i32>) -> i32 {
    // println!("entrando a expensive_sum");
    pause_ms(500);
...
fn main() {
    ...
    */
    ...
    let handle_a_b = thread::spawn(move || expensive_sum(my_vector));
    ...
    let sum = handle_a_b.join().unwrap();
    ...
    */
    ...
    // /*
       ...
       for i in 0..5 {
           pause_ms(0);
           println!("Sending value {} to child thread.", i);
           tx.send(i).unwrap();
       }
...
// fn run_challenge() {
//     let (tx, rx): (crossbeam::Sender<i32>, crossbeam::Receiver<i32>) = channel::unbounded();
//     let rx2 = rx.clone();

//     let handle_a = std::thread::spawn(move || {
//         for data in rx {
//             println!("Thread A: {}", data);
//         }
//     });

//     let handle_b = std::thread::spawn(move || {
//         for data in rx2 {
//             println!("Thread B: {}", data);
//         }
//     });
