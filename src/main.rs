...
// import print_difference
// use rust_practice::print_array;
// use rust_practice::print_difference;
// use rust_practice::ding;
use rust_practice::{ding, on_off, print_array, print_difference};
